...
public class DefaultVideoGatewayTest {
    ...
    public void givenAValidVideo_whenCallsCreate_shouldPersistIt() {
        ...
        final AudioVideoMedia expectedVideo = Fixture.Videos.audioVideo(VideoMediaType.VIDEO);

        final AudioVideoMedia expectedTrailer = Fixture.Videos.audioVideo(VideoMediaType.TRAILER);

        final ImageMedia expectedBanner = Fixture.Videos.imageMedia(VideoMediaType.BANNER);

        final ImageMedia expectedThumb = Fixture.Videos.imageMedia(VideoMediaType.THUMBNAIL);

        final ImageMedia expectedThumbHalf =Fixture.Videos.imageMedia(VideoMediaType.THUMBNAIL_HALF);
    ...
    @Test
    @Transactional
    public void givenAValidVideo_whenCallsUpdate_shouldPersistIt() throws Exception {
        // given
