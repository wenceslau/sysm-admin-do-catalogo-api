package com.sysm.catalog.admin.infrastructure.e2e.castmembers;
...
@E2ETest
@Testcontainers
public class CastMembersE2ETest extends ContainerTest implements MockDsl {
    ...
    public void asACatalogAdminIShouldBeAbleToSeeATreatedErrorByGettingANotFoundCastMember() throws Exception {
        ...
        retrieveACastMemberResult(CastMemberID.from("123"))
                ...
                .andExpect(jsonPath("$.message", equalTo("The CastMember with id 123 was not found")));
    }
