...
public class GCStorageServiceTest {
    ...
    public void givenResource_whenCallsGet_shouldRetrieveIt() {
        ...
        Assertions.assertEquals(expectedResource.checksum(), actualContent.get().checksum());
        Assertions.assertEquals(expectedResource.name(), actualContent.get().name());
        Assertions.assertEquals(expectedResource.content(), actualContent.get().content());
        Assertions.assertEquals(expectedResource.contentType(), actualContent.get().contentType());
    }
