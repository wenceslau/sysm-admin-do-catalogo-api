...
import com.sysm.catalog.admin.infrastructure.configuration.properties.google.GoogleCloudProperties;
...
@Configuration
@Profile({"!development & !test-integration & !test-e2e"}) //run in any profile different of this both
