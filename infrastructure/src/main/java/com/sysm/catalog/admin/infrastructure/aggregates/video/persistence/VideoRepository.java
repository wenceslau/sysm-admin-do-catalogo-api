package com.sysm.catalog.admin.infrastructure.aggregates.video.persistence;
...
public interface VideoRepository extends JpaRepository<VideoJpaEntity, String> {
    ...
    @Query("""
            select distinct new com.sysm.catalog.admin.domain.aggregates.video.records.VideoPreview(
                v.id,
                v.title,
                v.description,
                v.createdAt,
